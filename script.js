...
// ======================================================================//
//querySelector seleciona o elemento de uma classe do html
// getElementById seleciona o elemento de um id do html
// getElementsByClassName seleciona o elemento de uma classe do html
// getElementsByTagName seleciona o elemento de uma tag do html
//let produtosFiltrados = produtos; //cria uma cópia do array original
// let produtosFiltrados = []; //cria um array vazio
// arrays são mutáveis, ou seja, podem ser alterados
// ======================================================================//
...
function mostrarProdutos() {
  ...
  produtos.forEach((prd) => {
    if (prd.nome.toLocaleLowerCase().includes(textoinput.toLocaleLowerCase())) {
      //responsavel por colocar o produto na tela
  ...
  //pega item por item do meu array, e ai eu posso decidir o que fazer com cada um.
